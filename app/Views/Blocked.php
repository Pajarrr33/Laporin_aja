...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/assets/css/error401.css" />
    ...
    <script nonce="b80d95f6-b659-48b5-a442-9d300285957d">
    (function(w, d) {
        ! function(j, k, l, m) {
            j[l] = j[l] || {};
            j[l].executed = [];
...
<body>
    <div id="notfound">
        <div class="notfound">
            ...
            <h2>we are sorry, but you not authorized to access that page</h2>
        </div>
    </div>
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"82951dd1caf3be83","version":"2023.10.0","token":"cd0b4b3a733644fc843ef0b185f98241"}'
